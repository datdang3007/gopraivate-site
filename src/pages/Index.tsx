      ...
      <div className="flex flex-col">
        ...
        <section className="py-20 px-4 text-center bg-gradient-to-b from-background to-muted/20">
          <div className="container mx-auto max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Use AI-powered tools safely with our privacy-first approach. 
              Your data stays secure while you enjoy advanced AI capabilities.
            </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    AI tools often compromise your privacy. We ensure your data stays private and secure.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Your sensitive information is protected with enterprise-grade security measures.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    You maintain complete control over your data and how it's processed.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-20 px-4 bg-muted/30">
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto items-center">
              <div>
                <h3 className="text-xl font-semibold mb-4">Simple and Secure</h3>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of organizations who trust goprAIvate for their AI needs.
            </p>
            <Button size="lg" className="px-8">
              Start Free Trial
            </Button>

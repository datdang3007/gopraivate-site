...
import { Paperclip, Settings, Send, Copy, ThumbsUp, ThumbsDown, RotateCcw, User, Bot } from "lucide-react";
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        type: 'ai',
        content: "This is a simulated AI response. In a real implementation, this would be connected to your chosen AI model with privacy protection enabled.",
        timestamp: new Date(),
        model: "ChatGPT"
      };
            ...
            {messages.length === 0 ? (
              <div className="text-center py-12">
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    Your messages are automatically protected with PII redaction and privacy shielding.
                  </p>
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 max-w-3xl mx-auto">
                  ...
                  >
                    <p className="text-sm text-gray-700">Help me write a professional email</p>
                  </Card>
                  <Card 
                    className="p-4 cursor-pointer hover:shadow-md transition-shadow border-dashed"
                    onClick={() => setPrompt("Explain this code to me")}
                  >
                    <p className="text-sm text-gray-700">Explain this code to me</p>
                  </Card>
                  <Card 
                    className="p-4 cursor-pointer hover:shadow-md transition-shadow border-dashed"
              ...
              messages.map((message) => (
                <div key={message.id} className={`flex gap-3 ${message.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                  ...
                  <div className={`max-w-xs sm:max-w-md lg:max-w-2xl ${message.type === 'user' ? 'order-first' : ''}`}>
